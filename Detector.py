...
class Detector:
    ...
    def downloadMode(self, modelURL):
    ...
    def createBox(self, image, threshold=0.5):
        ...
        imageHeight, imageWidth, imgC = image.shape
        ...
        if len(bboxIdx) != 0:
            for i in range(0, len(bboxIdx)):
                ...
                xmin, xmax, ymin, ymax = (
                    xmin*imageWidth, xmax * imageWidth, ymax * imageHeight, ymin * imageHeight)

                xmin, xmax, ymin, ymax = int(xmin), int(
                    xmax), int(ymax), int(ymin)
    ...
    def predictImage(self, imagePath, threshold=0.5):
        ...
        bboxImage = self.createBox(image, threshold)
